...
class VGG16(tf.keras.Model):
  ...
  Args:
    ...
    trainable: Is the model trainable? If true, performs backward -- omitted for manual insertion
  ...
  def __init__(self, classes=1, name='', trainable=False, dropout=True, data_format='channels_last'):    # modified
    ...
    self.conv1_1 = layers.Conv2D(64, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv1_1', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv1_1_0), bias_initializer=tf.constant_initializer(conv1_1_1),
                                 trainable=trainable)
    self.conv1_2 = layers.Conv2D(64, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv1_2', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv1_2_0), bias_initializer=tf.constant_initializer(conv1_2_1),
                                 trainable=trainable)
    ...
    self.conv2_1 = layers.Conv2D(128, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv2_1', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv2_1_0), bias_initializer=tf.constant_initializer(conv2_1_1),
                                 trainable=trainable)
    self.conv2_2 = layers.Conv2D(128, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv2_2', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv2_2_0), bias_initializer=tf.constant_initializer(conv2_2_1),
                                 trainable=trainable)
    ...
    self.conv3_1 = layers.Conv2D(256, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv3_1', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv3_1_0), bias_initializer=tf.constant_initializer(conv3_1_1),
                                 trainable=trainable)
    self.conv3_2 = layers.Conv2D(256, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv3_2', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv3_2_0), bias_initializer=tf.constant_initializer(conv3_2_1),
                                 trainable=trainable)
    self.conv3_3 = layers.Conv2D(256, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv3_3', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv3_3_0), bias_initializer=tf.constant_initializer(conv3_3_1),
                                 trainable=trainable)
    ...
    self.conv4_1 = layers.Conv2D(512, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv4_1', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv4_1_0), bias_initializer=tf.constant_initializer(conv4_1_1),
                                 trainable=trainable)
    self.conv4_2 = layers.Conv2D(512, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv4_2', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv4_2_0), bias_initializer=tf.constant_initializer(conv4_2_1),
                                 trainable=trainable)
    self.conv4_3 = layers.Conv2D(512, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv4_3', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv4_3_0), bias_initializer=tf.constant_initializer(conv4_3_1),
                                 trainable=trainable)
    ...
    self.conv5_1 = layers.Conv2D(512, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv5_1', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv5_1_0), bias_initializer=tf.constant_initializer(conv5_1_1),
                                 trainable=trainable)
    self.conv5_2 = layers.Conv2D(512, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv5_2', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv5_2_0), bias_initializer=tf.constant_initializer(conv5_2_1),
                                 trainable=trainable)
    self.conv5_3 = layers.Conv2D(512, (3, 3), strides=(1, 1), data_format=data_format, padding='same', name='conv5_3', activation='relu',
                                 kernel_initializer=tf.constant_initializer(conv5_3_0), bias_initializer=tf.constant_initializer(conv5_3_1),
                                 trainable=trainable)
    ...
    self.fc8 = layers.Dense(classes, activation="softmax",  name='FC8', trainable=True)
